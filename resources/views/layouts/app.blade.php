...
<body class="font-sans antialiased">
    {{-- Tambahkan x-data untuk state sidebar di mobile --}}
    <div x-data="{ sidebarOpen: false }" class="min-h-screen bg-gray-50">

        <!-- A. SIDEBAR -->
        {{-- Logika baru untuk tampilan mobile dan desktop --}}
        <aside
        ...
        <!-- B. KONTEN UTAMA -->
        {{-- Tambahkan md:ml-64 agar margin hanya berlaku di layar besar --}}
        <div class="flex-1 flex flex-col md:ml-64">
            ...
            <header class="bg-white p-4 flex items-center justify-between border-b border-gray-200">
                ...
                <!-- Spacer untuk menengahkan search bar di desktop -->
                <div class="hidden md:block"></div>

                <!-- Dropdown Pengguna (tetap di kanan) -->
