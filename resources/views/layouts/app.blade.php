    ...
    <div class="min-h-screen bg-gray-50">
        <div class="flex">
            ...
            <div class="flex-1 flex flex-col ml-64">
                <!-- Header / Topbar -->
                <header class="bg-white p-4 flex items-center justify-end border-b border-gray-200">
                    <div class="flex items-center space-x-4">
                        <div class="relative">
                            <button class="p-2 rounded-full text-gray-500 hover:bg-gray-100 hover:text-gray-700 transition">
