    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <header class="mb-8">
            ...
            <p class="mt-1 text-sm text-gray-500">
                Isi form di bawah untuk menambahkan produk baru ke dalam sistem.
            </p>
        </header>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <div class="relative mt-1 rounded-md shadow-sm">
                                ...
                                <input type="number" name="price" id="price" value="{{ old('price') }}" required class="block w-full rounded-md border-gray-300 pl-8 focus:border-blue-500 focus:ring-blue-500 sm:text-sm" placeholder="0">
                            </div>
                        ...
                        <div>
                            ...
                            <input type="number" name="stock" id="stock" value="{{ old('stock') }}" required class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm" placeholder="0">
